...
export declare enum MainStatusCode {
    Unknown = "unknown",
    CapacityErr = "insufficient_capacity"
}
export declare enum SignalRequestSignalEnum {
    SIGABRT = "SIGABRT",
    SIGALRM = "SIGALRM",
    SIGFPE = "SIGFPE",
    SIGHUP = "SIGHUP",
 ...
 * * on-failure - Try up to MaxRetries times to automatically restart the Machine if it exits with a non-zero exit code. Default when no explicit policy is set, and for Machines with schedules.
 */
export declare enum ApiMachineRestartPolicyEnum {
    No = "no",
    Always = "always",
...
/** desired state */
export declare enum MachinesWaitParams1StateEnum {
    Started = "started",
    Stopped = "stopped",
    Destroyed = "destroyed"
}
